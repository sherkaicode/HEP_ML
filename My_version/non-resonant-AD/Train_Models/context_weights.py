...
def main():
    ...
    for p in per:
        ...
        NN_reweight.train(input_x_train_CR, input_y_train_CR, save_model=True, batch_size=params["batch_size"], n_epochs=params["n_epochs"], model_name=f"context_weight_{p}", outdir=model_dir)
        
        print("Done training for s/b =", p)

    print("Train Context Weights Done for seed =", args.gen_seed)
